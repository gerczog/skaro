    ...
    async def serve_dashboard(path: str):
        try:
            ...
            return HTMLResponse(
                ...
                "<li>Or from the Skaro repo: <code>cd frontend && npm install && npm run build</code>, then <code>~/.skaro/venv/bin/pip install -e .</code> the repo’s built static files.</li>"
                "</ul>"
